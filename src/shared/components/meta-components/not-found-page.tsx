...
export default function NotFoundPage() {
    ...
    return (
      <div className="from-background via-background to-primary/5 flex min-h-screen items-center justify-center bg-gradient-to-br">
        <div className="text-center">
          <div className="from-primary via-primary to-primary/70 mb-4 bg-gradient-to-r bg-clip-text text-8xl font-black text-transparent">
            404
          </div>
  ...
  return (
    <div className="from-background via-background to-primary/5 relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            >
              <span className="from-primary via-primary to-primary/70 relative bg-gradient-to-r bg-clip-text text-transparent">
                4
                {!isMobile && (
                  <motion.div
                    className="from-primary/20 absolute inset-0 rounded-3xl bg-gradient-to-r to-transparent blur-3xl"
                    animate={{
                      scale: [1, 1.2, 1],
                      opacity: [0.5, 0.8, 0.5],
                    }}
              ...
              <span className="from-foreground via-foreground to-foreground/70 relative mx-2 bg-gradient-to-r bg-clip-text text-transparent sm:mx-4">
          ...
          >
            {[
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                className="from-primary/10 to-primary/5 border-primary/20 group flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl border bg-gradient-to-r sm:h-16 sm:w-16 sm:rounded-2xl"
              >
