...
export default function MobileOptimizedNotFound() {
  ...
  if (!isClient) {
    return (
      <div className="from-background to-primary/5 flex min-h-screen items-center justify-center bg-gradient-to-br p-4">
  ...
  return (
    <div className="from-background to-primary/5 relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br p-4">
      ...
      <div className="relative z-10 mx-auto w-full max-w-md">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="from-primary via-primary to-primary/70 bg-gradient-to-r bg-clip-text text-7xl leading-none font-black text-transparent sm:text-8xl">
              404
            </h1>
          </motion.div>
