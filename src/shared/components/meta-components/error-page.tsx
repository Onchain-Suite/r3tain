      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            >
              <div className="from-destructive/20 to-destructive/10 border-destructive/30 relative flex h-full w-full items-center justify-center overflow-hidden rounded-3xl border-2 bg-gradient-to-r">
            ...
            >
              <span className="from-destructive via-destructive to-destructive/70 bg-gradient-to-r bg-clip-text text-transparent">
                500
              </span>
            </motion.h1>
          </motion.div>
          ...
          >
            <h2 className="mb-4 text-2xl font-bold sm:text-3xl md:text-4xl">
              Something went{" "}
              <span className="from-destructive to-destructive/70 bg-gradient-to-r bg-clip-text text-transparent">
                wrong
              </span>
            </h2>
