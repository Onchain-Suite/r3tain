...
export default function ForbiddenPage() {
  ...
  return (
    <div className="from-background via-background relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br to-yellow-500/5">
      {/* Animated Background */}
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            >
              <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-3xl border-2 border-yellow-500/30 bg-gradient-to-r from-yellow-500/20 to-yellow-500/10">
            ...
            >
              <span className="bg-gradient-to-r from-yellow-500 via-yellow-500 to-yellow-600 bg-clip-text text-transparent">
                403
              </span>
            </motion.h1>
          </motion.div>
