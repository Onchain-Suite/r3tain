      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center p-4">
        ...
        >
          ...
          >
            ...
            <motion.div
              className="from-primary/10 via-primary/5 border-primary/20 absolute inset-0 rounded-3xl border bg-gradient-to-br to-transparent backdrop-blur-sm"
              animate={{
                boxShadow: [
          ...
          >
            ...
            <div className="space-y-4">
              <motion.h1
                className="from-foreground via-foreground to-foreground/70 bg-gradient-to-r bg-clip-text text-4xl font-black text-transparent md:text-6xl"
                variants={{
