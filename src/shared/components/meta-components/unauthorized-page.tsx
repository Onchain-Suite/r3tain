...
export default function UnauthorizedPage() {
  ...
  return (
    <div className="from-background via-background relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br to-orange-500/5">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          ...
          >
            ...
            >
              <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-3xl border-2 border-orange-500/30 bg-gradient-to-r from-orange-500/20 to-orange-500/10">
