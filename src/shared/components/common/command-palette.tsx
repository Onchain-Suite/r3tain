...
export function CommandPalette({ open, setOpen }: CommandPaletteProps) {
  ...
  const navigationItems: NavigationItem[] = [
    ...
    },
    {
      label: "Campaigns",
      icon: Megaphone,
      route: dashboardRoutes.campaigns,
    },
    {
      label: "Automation",
      icon: FileText,
      route: dashboardRoutes.automation,
    },
    {
      label: "Community",
      icon: Users,
      route: dashboardRoutes.community,
    },
    {
      label: "Analytics",
      icon: BarChart3,
      route: dashboardRoutes.analytics,
    },
  ];
  ...
  const quickActions: ActionItem[] = [
    {
      ...
      icon: Plus,
      action: () => navigateToRoute(dashboardRoutes.newCampaign),
      shortcut: "⌘N",
    },
    {
  ...
  const settingsItems: ActionItem[] = [
    {
      label: "Settings",
      icon: Settings,
      action: () => navigateToRoute(dashboardRoutes.settings),
      shortcut: "⌘,",
    },
    {
      label: "Profile",
      icon: User,
      action: () => navigateToRoute(dashboardRoutes.profile),
    },
    {
      label: "Billing",
      icon: CreditCard,
      action: () => navigateToRoute(dashboardRoutes.billing),
    },
  ];
